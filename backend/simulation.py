...
class AircraftSimulation:
    ...
    def set_turbulence_intensity(self, intensity: TurbulenceIntensity):
        self._intensity = intensity
        self.state.turbulence_intensity = intensity

    def trigger_pulse(self, intensity: TurbulenceIntensity):
        amplitudes = {"low": 5.0, "medium": 10.0, "high": 16.0}
        self._pulse_ticks_remaining = 8
        self._pulse_amplitude       = amplitudes[intensity]
    ...
    def step(self) -> SimulationState:
        ...
        new_pos_x = max(-15.0, min(15.0, new_pos_x))
        new_pos_y = max(-15.0, min(15.0, new_pos_y))
